...
<head>
	...
	<link href="utils/css/material-dashboard.css" rel="stylesheet"/>

	<!--  CSS for Demo Purpose, don't include it in your project     -->
	<link href="utils/css/demo.css" rel="stylesheet" />
	<link href="utils/css/sweetalert.css" rel="stylesheet" />

	<!--  Fonts and icons  -->
	<link href="utils/css/font-awesome.min.css" rel="stylesheet">
...
<body onload="load('<%=session.getAttribute("menu")%>')">
    ...
    <!--   Core JS Files   -->
    <script src="utils/js/jquery-2.1.1.min.js" type="text/javascript"></script>
    ...
    <script src="utils/js/moment.min.js"></script>

    <!--  Charts Plugin -->
    <script src="utils/js/chartist.min.js"></script>

    <!--   Sharrre Library    -->
    <script src="utils/js/jquery.sharrre.js"></script>

    <!--  Plugin for the Wizard -->
    <script src="utils/js/jquery.bootstrap-wizard.js"></script>

    <!--  Notifications Plugin    -->
    <script src="utils/js/bootstrap-notify.js"></script>

    <!-- DateTimePicker Plugin -->
    <script src="utils/js/bootstrap-datetimepicker.js"></script>

    <!-- Vector Map plugin -->
    <script src="utils/js/jquery-jvectormap.js"></script>

    <!-- Sliders Plugin -->
    <script src="utils/js/nouislider.min.js"></script>


    <!-- Select Plugin -->
    <script src="utils/js/jquery.select-bootstrap.js"></script>

    <!--  DataTables.net Plugin    -->
    <script src="utils/js/jquery.datatables.js"></script>

    <!-- Sweet Alert 2 plugin -->
    <script src="utils/js/sweetalert2.js"></script>
    <script src="utils/js/sweetalert.min.js"></script>

    <!--    Plugin for Fileupload, full documentation here: http://www.jasny.net/bootstrap/javascript/#fileinput -->
    <script src="utils/js/jasny-bootstrap.min.js"></script>

    <!--  Full Calendar Plugin    -->
    <script src="utils/js/fullcalendar.min.js"></script>

    <!-- TagsInput Plugin -->
    <script src="utils/js/jquery.tagsinput.js"></script>

    <!-- Material Dashboard javascript methods -->
    <script src="utils/js/material-dashboard.js"></script>

    <!-- Material Dashboard DEMO methods, don't include it in your project! -->
    <script src="utils/js/demo.js"></script>
